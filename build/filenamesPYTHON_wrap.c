...
/*-----------------------------------------------
              @(target):= _filenames.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__filenames

#else
#  define SWIG_init    init_filenames

#endif
#define SWIG_name    "_filenames"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_read_geometry_main(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  
  if (!SWIG_Python_UnpackTuple(args, "read_geometry_main", 0, 0, 0)) SWIG_fail;
  read_geometry_main();
...
SWIGINTERN PyObject *_wrap_read_geometry_evaluate_flow(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  
  if (!SWIG_Python_UnpackTuple(args, "read_geometry_evaluate_flow", 0, 0, 0)) SWIG_fail;
...
SWIGINTERN PyObject *_wrap_get_filename(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  char *arg1 = (char *) 0 ;
  int res1 ;
  char *buf1 = 0 ;
  ...
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "get_filename" "', argument " "1"" of type '" "char const *""'");
  }
  arg1 = (char *)(buf1);
  result = (char *)get_filename((char const *)arg1);
...
static PyMethodDef SwigMethods[] = {
	 { "read_geometry_main", _wrap_read_geometry_main, METH_NOARGS, NULL},
	 { "read_geometry_evaluate_flow", _wrap_read_geometry_evaluate_flow, METH_NOARGS, NULL},
	 { "get_filename", _wrap_get_filename, METH_O, NULL},
	 { NULL, NULL, 0, NULL }
};
